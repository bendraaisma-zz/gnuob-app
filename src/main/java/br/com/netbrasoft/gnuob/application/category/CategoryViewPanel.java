...
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_CONTENT_PANEL_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_SUB_CATEGORY_PANEL_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_VIEW_CONTAINER_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_VIEW_FORM_COMPONENT_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_VIEW_TABLE_CONTAINER_ID;
  ...
  class CategoryViewContainer extends WebMarkupContainer {
    ...
    class CategoryViewTableContainer extends WebMarkupContainer {
      ...
      private BootstrapForm<Category> createCategoryViewForm() {
        return new BootstrapForm<>(CATEGORY_VIEW_FORM_COMPONENT_ID, createCategoryCompoundPropertyModel());
      }

      private CompoundPropertyModel<Category> createCategoryCompoundPropertyModel() {
        return new CompoundPropertyModel<>(getCategoryModel());
      }

      private CategoryContentPanel createCategoryContentPanel() {
        return new CategoryContentPanel(CATEGORY_CONTENT_PANEL_ID, getCategoryModel());
      }

      private CategorySubCategoryPanel createCategorySubCategoryPanel() {
        return new CategorySubCategoryPanel(CATEGORY_SUB_CATEGORY_PANEL_ID, getCategoryModel());
      }

      private IModel<Category> getCategoryModel() {
        return (IModel<Category>) CategoryViewTableContainer.this.getDefaultModel();
      }
