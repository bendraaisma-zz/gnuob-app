...
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.SUB_CATEGORY_EDIT_FORM_ID;
...
public class CategorySubCategoryEditModal extends Modal<SubCategory> {
  ...
  private Component getSaveButtonComponent() {
    return saveButton.add(createTinyMceAjaxSubmitModifier()).setOutputMarkupId(true);
  }

  private TinyMceAjaxSubmitModifier createTinyMceAjaxSubmitModifier() {
    return new TinyMceAjaxSubmitModifier();
  }
