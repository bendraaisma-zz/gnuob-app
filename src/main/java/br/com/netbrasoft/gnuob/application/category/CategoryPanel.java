...
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_DATAVIEW_CONTAINER_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_DATAVIEW_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_EDIT_MODAL_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_PAGING_NAVIGATOR_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_PANEL_CONTAINER_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_TABLE_CONTAINER_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_VIEW_PANEL_ID;
...
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.FEEDBACK_ID;
...
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.NAME_PROPERTY;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.ORDER_BY_NAME_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.ORDER_BY_POSITION_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.POSITION_ID;
import static br.com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.POSITION_PROPERTY;
    ...
    class CategoryTableContainer extends WebMarkupContainer {
      ...
      class CategoryDataviewContainer extends WebMarkupContainer {
        ...
        class CategoryDataview extends DataView<Category> {
          ...
          class RemoveAjaxLink extends BootstrapAjaxLink<Category> {
            ...
            protected void onInitialize() {
              ...
              setSize(Buttons.Size.Mini);
              add(createRemoveConfirmationBehavior());
            }

            private RemoveAjaxConfirmationBehavior createRemoveConfirmationBehavior() {
          ...
          protected Item<Category> newItem(final String id, final int index, final IModel<Category> model) {
            ...
            if (isSelected(model)) {
              item.add(createSelectAttributeModifier());
            } else {
              item.add(createUnSelectAttributeModifier());
            }
            return item;
          }
          ...
          private AttributeModifier createSelectAttributeModifier() {
            return new AttributeModifier(CLASS_ATTRIBUTE, INFO_VALUE);
          }

          private AttributeModifier createUnSelectAttributeModifier() {
            return new AttributeModifier(CLASS_ATTRIBUTE, StringUtils.EMPTY);
          }

          @Override
          protected void populateItem(final Item<Category> item) {
            item.setModel(createCompoundPropertyModel(item.getModelObject()));
            item.add(createNameLabel());
            item.add(createPositionLabel());
            item.add(createEventBehavior(item.getModel()));
            item.add(createEditLink(item.getModel()));
            item.add(createRemoveLink(item.getModel()));
          }

          private CompoundPropertyModel<Category> createCompoundPropertyModel(Category category) {
            return new CompoundPropertyModel<>(category);
          }
          ...
          private AjaxEventBehavior createEventBehavior(final IModel<Category> model) {
          ...
          private AddAjaxLink createEditLink(final IModel<Category> model) {
            return new AddAjaxLink(EDIT_ID, model, Buttons.Type.Default,
                Model.of(CategoryPanel.this.getString(EDIT_MESSAGE_KEY)));
          }

          private RemoveAjaxLink createRemoveLink(final IModel<Category> model) {
        ...
        public CategoryDataviewContainer(final String id, final IModel<Category> model) {
          super(id, model);
          categoryDataview = createCategoryDataview();
        }

        private CategoryDataview createCategoryDataview() {
