...
public class SettingViewPanel extends Panel {
   ...
   private OrderByBorder<String> orderByProperty = new OrderByBorder<String>("orderByProperty", "property",
         settingDataProvider);
   ...
   private OrderByBorder<String> orderByDescription = new OrderByBorder<String>("orderByDescription", "description",
         settingDataProvider);
   private DataView<Setting> settingDataview = new DataView<Setting>("settingDataview", settingDataProvider,
         ITEMS_PER_PAGE) {
   ...
   private ItemsPerPagePagingNavigator settingPagingNavigator = new ItemsPerPagePagingNavigator(
         "settingPagingNavigator", settingDataview);
