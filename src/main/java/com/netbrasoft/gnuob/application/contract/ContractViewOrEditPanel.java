...
public class ContractViewOrEditPanel extends Panel {
  ...
  class CancelAjaxLink extends BootstrapAjaxLink<String> {
    ...
    public CancelAjaxLink() {
      super("cancel", Model.of(ContractViewOrEditPanel.this.getString("cancelMessage")), Buttons.Type.Default,
          Model.of(ContractViewOrEditPanel.this.getString("cancelMessage")));
  ...
  class ContractEditFragement extends Fragment {
    ...
    public ContractEditFragement() {
      ...
      contractEditTable = new WebMarkupContainer("contractEditTable", getDefaultModel()) {
        ...
        protected void onInitialize() {
          ...
          contractEditForm.add(new TextField<String>("customer.payer").setLabel(Model.of(getString("payerMessage"))).add(EmailAddressValidator.getInstance())
              .add(StringValidator.maximumLength(127)));
    ...
    @Override
    protected void onInitialize() {
      add(contractEditTable.setOutputMarkupId(true));
      super.onInitialize();
    }
  }
  ...
  class ContractViewFragement extends Fragment {
    ...
    private final WebMarkupContainer contractViewTable;
    ...
    public ContractViewFragement() {
      ...
      contractViewTable = new WebMarkupContainer("contractViewTable", getDefaultModel()) {

        private static final long serialVersionUID = 5655019574636840658L;
    ...
    @Override
    protected void onInitialize() {
      add(contractViewTable.setOutputMarkupId(true));
      super.onInitialize();
    }
  }
