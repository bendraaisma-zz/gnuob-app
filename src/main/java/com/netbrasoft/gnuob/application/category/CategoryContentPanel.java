...
public class CategoryContentPanel extends Panel {
   ...
   class AddAjaxLink extends BootstrapAjaxLink<String> {
      ...
      public AddAjaxLink() {
         super("add", Model.of(CategoryContentPanel.this.getString("addMessage")), Buttons.Type.Primary, Model.of(CategoryContentPanel.this.getString("addMessage")));
   ...
   class RemoveAjaxLink extends BootstrapAjaxLink<Content> {
      ...
      public RemoveAjaxLink(final IModel<Content> model) {
         super("remove", model, Buttons.Type.Default, Model.of(CategoryContentPanel.this.getString("removeMessage")));
