...
import static com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_SUB_CATEGORY_CONTAINER_ID;
import static com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_SUB_CATEGORY_EDIT_MODAL_ID;
import static com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.CATEGORY_SUB_CATEGORY_TABLE_CONTAINER_ID;
import static com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.SUB_CATEGORY_DATAVIEW_ID;
import static com.netbrasoft.gnuob.application.NetbrasoftApplicationConstants.SUB_CATEGORY_DATA_VIEW_CONTAINER_ID;
...
public class CategorySubCategoryPanel extends Panel {
  ...
  class CategorySubCategoryContainer extends WebMarkupContainer {
    ...
    class CategorySubCategoryTableContainer extends WebMarkupContainer {
      ...
      class AddAjaxLink extends BootstrapAjaxLink<SubCategory> {
        ...
        private boolean userSelectedOneCategory() {
      ...
      class SubCategoryDataViewContainer extends WebMarkupContainer {
        ...
        public SubCategoryDataViewContainer(String id, IModel<Category> model) {
          super(id, model);
          subCategoryDataview = getSubCategoryDataview();
        }
      ...
      private AddAjaxLink createAddLink() {
        return new AddAjaxLink(ADD_ID, Model.of(new SubCategory()), Buttons.Type.Primary,
      ...
      private SubCategoryDataViewContainer createSubCategoryDataViewContainer() {
        return new SubCategoryDataViewContainer(SUB_CATEGORY_DATA_VIEW_CONTAINER_ID,
            (IModel<Category>) CategorySubCategoryTableContainer.this.getDefaultModel());
      }

      private CategorySubCategoryEditModal createCategorySubCategoryEditModel() {
        return new CategorySubCategoryEditModal(CATEGORY_SUB_CATEGORY_EDIT_MODAL_ID, Model.of(new SubCategory()));
      }
    ...
    public CategorySubCategoryContainer(String id, IModel<Category> model) {
      super(id, model);
      categorySubCategoryTableContainer = getCategorySubCategoryTableContainer();
    }

    private CategorySubCategoryTableContainer getCategorySubCategoryTableContainer() {
  ...
  public CategorySubCategoryPanel(String id, IModel<Category> model) {
    super(id, model);
    categorySubCategoryContainer = getCategorySubCategoryContainer();
  }

  private CategorySubCategoryContainer getCategorySubCategoryContainer() {
