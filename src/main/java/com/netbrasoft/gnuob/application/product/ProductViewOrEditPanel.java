  ...
  class ProductEditFragment extends Fragment {
    ...
    class ProductEditTable extends WebMarkupContainer {
      ...
      class CancelAjaxLink extends BootstrapAjaxLink<Product> {
        ...
        public CancelAjaxLink(final String id, final IModel<Product> model, final Buttons.Type type, final IModel<String> labelModel) {
      ...
      public ProductEditTable(final String id, final IModel<Product> model) {
        super(id, model);
        productEditForm = new BootstrapForm<Product>(PRODUCT_EDIT_FORM_COMPONENT_ID, new CompoundPropertyModel<Product>((IModel<Product>) ProductEditTable.this.getDefaultModel()));
        productOptionPanel = new ProductOptionPanel(OPTION_VIEW_OR_EDIT_PANEL_ID, (IModel<Product>) ProductEditTable.this.getDefaultModel());
        contentViewOrEditPanel = new ProductContentPanel(CONTENT_VIEW_OR_EDIT_PANEL_ID, (IModel<Product>) ProductEditTable.this.getDefaultModel());
        subCategoryViewOrEditPanel = new ProductSubCategoryPanel(SUB_CATEGORY_VIEW_OR_EDIT_PANEL_ID, (IModel<Product>) ProductEditTable.this.getDefaultModel());
        cancelAjaxLink =
            new CancelAjaxLink(CANCEL_ID, model, Buttons.Type.Default, Model.of(ProductViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.CANCEL_MESSAGE_KEY)));
        saveAjaxButton = new SaveAjaxButton(SAVE_ID, Model.of(ProductViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.SAVE_AND_CLOSE_MESSAGE_KEY)), productEditForm,
      ...
      protected void onInitialize() {
        productEditForm.add(new RequiredTextField<String>(NUMBER_ID).add(StringValidator.maximumLength(64)).setOutputMarkupId(true));
        productEditForm.add(new RequiredTextField<String>(NAME_ID).add(StringValidator.maximumLength(128)).setOutputMarkupId(true));
        productEditForm.add(new TextArea<String>(DESCRIPTION_ID).add(StringValidator.maximumLength(128)).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new UrlTextField(ITEM_URL_ID, new PropertyModel<String>(getDefaultModelObject(), ITEM_URL_ID)).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(AMOUNT_ID).setMinimum(BigDecimal.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(DISCOUNT_ID).setMinimum(BigDecimal.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(SHIPPING_COST_ID).setMinimum(BigDecimal.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(TAX_ID).setMinimum(BigDecimal.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(ITEM_HEIGHT_ID).setMinimum(BigDecimal.ZERO).setOutputMarkupId(true));
        productEditForm.add(new TextField<String>(ITEM_HEIGHT_UNIT_ID).add(StringValidator.maximumLength(20)).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(ITEM_LENGTH_ID).setMinimum(BigDecimal.ZERO).setOutputMarkupId(true));
        productEditForm.add(new TextField<String>(ITEM_LENGTH_UNIT_ID).add(StringValidator.maximumLength(20)).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(ITEM_WEIGHT_ID).setMinimum(BigDecimal.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new TextField<String>(ITEM_WEIGHT_UNIT_ID).add(StringValidator.maximumLength(20)).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigDecimal>(ITEM_WIDTH_ID).setMinimum(BigDecimal.ZERO).setOutputMarkupId(true));
        productEditForm.add(new TextField<String>(ITEM_WIDTH_UNIT_ID).add(StringValidator.maximumLength(20)).setOutputMarkupId(true));
        ...
        productEditForm.add(new NumberTextField<Integer>(RATING_ID).setMinimum(0).setMinimum(0).setMaximum(5).setOutputMarkupId(true));
        productEditForm.add(new BootstrapCheckbox(RECOMMENDED_ID).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigInteger>(STOCK_MAX_QUANTITY_ID).setMinimum(BigInteger.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigInteger>(STOCK_MIN_QUANTITY_ID).setMinimum(BigInteger.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(new NumberTextField<BigInteger>(STOCK_QUANTITY_ID).setMinimum(BigInteger.ZERO).setRequired(true).setOutputMarkupId(true));
        productEditForm.add(productOptionPanel.add(productOptionPanel.new ProductOptionEditFragment()).setOutputMarkupId(true));
        productEditForm.add(contentViewOrEditPanel.add(contentViewOrEditPanel.new ProductContentEditFragment()).setOutputMarkupId(true));
        productEditForm.add(subCategoryViewOrEditPanel.add(subCategoryViewOrEditPanel.new ProductSubCategoryEditFragment()).setOutputMarkupId(true));
    ...
    public ProductEditFragment() {
      super(PRODUCT_VIEW_OR_EDIT_FRAGMENT_ID, PRODUCT_EDIT_FRAGMENT_MARKUP_ID, ProductViewOrEditPanel.this, ProductViewOrEditPanel.this.getDefaultModel());
      productEditTable = new ProductEditTable(PRODUCT_EDIT_TABLE_ID, (IModel<Product>) ProductEditFragment.this.getDefaultModel());
    }
  ...
  class ProductViewFragment extends Fragment {
    ...
    class ProductViewTable extends WebMarkupContainer {
      ...
      protected void onInitialize() {
        ...
        productViewForm.add(new UrlTextField(ITEM_URL_ID, new PropertyModel<String>(getDefaultModelObject(), ITEM_URL_ID)).setOutputMarkupId(true));
        ...
        productViewForm.add(productOptionPanel.add(productOptionPanel.new ProductOptionViewFragment()).setOutputMarkupId(true));
        productViewForm.add(contentViewOrEditPanel.add(contentViewOrEditPanel.new ProductContentViewFragment()).setOutputMarkupId(true));
        productViewForm.add(subCategoryViewOrEditPanel.add(subCategoryViewOrEditPanel.new ProductSubCategoryViewFragment()).setOutputMarkupId(true));
    ...
    public ProductViewFragment() {
      super(PRODUCT_VIEW_OR_EDIT_FRAGMENT_ID, PRODUCT_VIEW_FRAGMENT_MARKUP_ID, ProductViewOrEditPanel.this, ProductViewOrEditPanel.this.getDefaultModel());
      productViewTable = new ProductViewTable(PRODUCT_VIEW_TABLE_ID, (IModel<Product>) ProductViewFragment.this.getDefaultModel());
    }
