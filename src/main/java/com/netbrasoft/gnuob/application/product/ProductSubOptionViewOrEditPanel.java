...
public class ProductSubOptionViewOrEditPanel extends Panel {
  ...
  class ProductSubOptionEditFragement extends Fragment {
    ...
    class SubOptionEditTable extends WebMarkupContainer {
      ...
      public SubOptionEditTable(final String id, final IModel<Product> model) {
        ...
        saveAjaxButton = new SaveAjaxButton("save", Model.of(ProductSubOptionViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.SAVE_MESSAGE_KEY)),
    ...
    public ProductSubOptionEditFragement() {
      super("productSubOptionViewOrEditFragement", "productSubOptionEditFragement", ProductSubOptionViewOrEditPanel.this,
  ...
  class ProductSubOptionViewFragement extends Fragment {
    ...
    public ProductSubOptionViewFragement() {
      super("productSubOptionViewOrEditFragement", "productSubOptionViewFragement", ProductSubOptionViewOrEditPanel.this,
          ProductSubOptionViewOrEditPanel.this.getDefaultModel());
