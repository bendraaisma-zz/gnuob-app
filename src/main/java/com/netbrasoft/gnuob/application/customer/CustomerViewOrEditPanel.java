...
public class CustomerViewOrEditPanel extends Panel {
  ...
  class CancelAjaxLink extends BootstrapAjaxLink<String> {
    ...
    public CancelAjaxLink() {
      super("cancel", Model.of(CustomerViewOrEditPanel.this.getString("cancelMessage")), Buttons.Type.Default,
          Model.of(CustomerViewOrEditPanel.this.getString("cancelMessage")));
