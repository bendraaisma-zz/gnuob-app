  ...
  class GroupEditFragment extends Fragment {
    ...
    class GroupEditTable extends WebMarkupContainer {
      ...
      class CancelAjaxLink extends BootstrapAjaxLink<Group> {
        ...
        public CancelAjaxLink(final String id, final IModel<Group> model, final Buttons.Type type, final IModel<String> labelModel) {
        ...
        public void onClick(final AjaxRequestTarget target) {
          ...
          if (((Group) CancelAjaxLink.this.getDefaultModelObject()).getId() > 0) {
            CancelAjaxLink.this.setDefaultModelObject(groupDataProvider.findById((Group) CancelAjaxLink.this.getDefaultModelObject()));
          }
          target.add(GroupViewOrEditPanel.this.add(GroupViewOrEditPanel.this.new GroupViewFragment()).setOutputMarkupId(true));
        }
      }
      ...
      class SaveAjaxButton extends BootstrapAjaxButton {
        ...
        public SaveAjaxButton(final String id, final IModel<String> model, final Form<?> form, final Buttons.Type type) {
          ...
          setSize(Buttons.Size.Small);
          add(new LoadingBehavior(Model.of(GroupViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.SAVE_AND_CLOSE_MESSAGE_KEY))));
        }
        ...
        protected void onError(final AjaxRequestTarget target, final Form<?> form) {
          ...
          target.add(form);
          target.add(SaveAjaxButton.this.add(new LoadingBehavior(Model.of(GroupViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.SAVE_AND_CLOSE_MESSAGE_KEY)))));
        }
        ...
        protected void onSubmit(final AjaxRequestTarget target, final Form<?> form) {
          try {
            if (((Group) form.getDefaultModelObject()).getId() == 0) {
              GroupEditTable.this.setDefaultModelObject(groupDataProvider.findById(groupDataProvider.persist((Group) form.getDefaultModelObject())));
            } else {
              GroupEditTable.this.setDefaultModelObject(groupDataProvider.findById(groupDataProvider.merge((Group) form.getDefaultModelObject())));
            }
            GroupViewOrEditPanel.this.removeAll();
      ...
      public GroupEditTable(final String id, final IModel<Group> model) {
        super(id, model);
        groupEditForm = new BootstrapForm<Group>(GROUP_EDIT_FORM_COMPONENT_ID, new CompoundPropertyModel<Group>((IModel<Group>) GroupEditTable.this.getDefaultModel()));
        cancelAjaxLink =
            new CancelAjaxLink(CANCEL_ID, model, Buttons.Type.Default, Model.of(GroupViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.CANCEL_MESSAGE_KEY)));
        saveAjaxButton = new SaveAjaxButton(SAVE_ID, Model.of(GroupViewOrEditPanel.this.getString(NetbrasoftApplicationConstants.SAVE_AND_CLOSE_MESSAGE_KEY)), groupEditForm,
    ...
    public GroupEditFragment() {
      super(GROUP_VIEW_OR_EDIT_FRAGMENT_ID, GROUP_EDIT_FRAGMENT_MARKUP_ID, GroupViewOrEditPanel.this, GroupViewOrEditPanel.this.getDefaultModel());
      groupEditTable = new GroupEditTable(GROUP_EDIT_TABLE_ID, (IModel<Group>) GroupEditFragment.this.getDefaultModel());
    }
  ...
  class GroupViewFragment extends Fragment {
    ...
    class GroupViewTable extends WebMarkupContainer {
      ...
      class EditAjaxLink extends BootstrapAjaxLink<Group> {
        ...
        public EditAjaxLink(final String id, final IModel<Group> model, final Buttons.Type type, final IModel<String> labelModel) {
          super(id, model, type, labelModel);
      ...
      public GroupViewTable(final String id, final IModel<Group> model) {
        super(id, model);
        groupViewForm = new BootstrapForm<Group>(GROUP_VIEW_FORM_COMPONENT_ID, new CompoundPropertyModel<Group>((IModel<Group>) GroupViewTable.this.getDefaultModel()));
        editAjaxLink = new EditAjaxLink(EDIT_ID, (IModel<Group>) GroupViewTable.this.getDefaultModel(), Buttons.Type.Primary,
    ...
    public GroupViewFragment() {
      super(GROUP_VIEW_OR_EDIT_FRAGMENT_ID, GROUP_VIEW_FRAGMENT_MARKUP_ID, GroupViewOrEditPanel.this, GroupViewOrEditPanel.this.getDefaultModel());
      groupViewTable = new GroupViewTable(GROUP_VIEW_TABLE_ID, (IModel<Group>) GroupViewFragment.this.getDefaultModel());
    }
